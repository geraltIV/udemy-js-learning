...
function cards() {
  ...
  Object(_services_services__WEBPACK_IMPORTED_MODULE_6__["getResource"])('http://localhost:3000/menu').then(function (data) {
...
function modal(triggerSelector, modalSelector, modalTimerId) {
  // Modal
  var modalOpen = document.querySelectorAll(triggerSelector),
...
function slider(_ref) {
  ...
  var slides = document.querySelectorAll(slide),
      ...
      slidesWarpper = document.querySelector(wrapper),
      slidesField = document.querySelector(field),
      width = window.getComputedStyle(slidesWarpper).width;
  var slideIndex = 1;
  var offset = 0; // showSlides(slideIndex);
  // if (slides.length < 10) {
  ...
  slidesField.style.transition = '.4s all ease-in-out';
  slidesWarpper.style.overflow = 'hidden';
  ...
  function setActiveDots(dotsArr) {
  ...
  function setCurrentSliderNumber(slidesArr, currentNum, index) {
    if (slidesArr.length < 10) {
      currentNum.textContent = "0".concat(index);
    } else {
  ...
  next.addEventListener('click', function () {
    ...
    setCurrentSliderNumber(slides, current, slideIndex);
    setActiveDots(dots);
  });
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2020-08-01');
